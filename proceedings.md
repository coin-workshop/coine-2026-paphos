...
Authors are encouraged to incorporate feedback from their previous submissions as well as any received during the presentations.

<p align="center">
  <img src="assets/image/lnai-logo.png" />
</p>
...
To submit your revised version of the paper, we need all source files (LaTeX files with all the associated style files, special fonts and eps files, or Word files) and the final pdfs of the paper. For papers prepared using LaTeX, authors should supply the bib/bbl files. Please make sure you give your files short names.

We ask authors to include a summary of their responses to the reviewers' comments and suggestions, noting any changes and additions to the original version of the paper. This should include any changes already made in the self-archived version that is linked from the workshop web site.


## Licence-to-Publish
The corresponding author of each paper, acting on behalf of all of the authors of that paper, must complete and sign the pre-filled <a href="assets/License-to-Publish Form, Default Word Switzerland.docx" target="_blank">License-to-Publish form</a>. The corresponding author signing the copyright form should match the corresponding author marked on the paper. Once the files have been sent to Springer, changes relating to the authorship of the papers cannot be made.
